			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="mb-3">
						...
						<textarea name="htmlBegin" id="htmlBegin" rows="6" class="form-control editor"><?= set_value('htmlBegin', isset($row->htmlBegin) ? $row->htmlBegin : '') ?></textarea>
					</div>
					<div class="mb-3">
						<?= form_label(lang('Webadmin.htmlEnd'), 'htmlEnd', ['class' => 'form-label']) ?>
						<textarea name="htmlEnd" id="htmlEnd" rows="6" class="form-control editor"><?= set_value('htmlEnd', isset($row->htmlEnd) ? $row->htmlEnd : '') ?></textarea>
					</div>
				</div>
				<div class="col-md-6">
					<div class="mb-3">
